...
namespace Multi\Packages\MultiTenant\Traits;

use Multi\Packages\MultiTenant\Exceptions\TenantModelNotFoundException;
...
trait TenantScopedModelTrait
{
    ...
    {
        $tenantScope = \App::make('Multi\Packages\MultiTenant\TenantScope');
