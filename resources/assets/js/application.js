...
if($('#gridSystem').length){$('#gridSystem').tooltip({selector:'.show-grid > [class*="span"]',title:function(){return $(this).width()+'px'}})}$('.tooltip-demo').tooltip({selector:"a[data-toggle=tooltip]"})
