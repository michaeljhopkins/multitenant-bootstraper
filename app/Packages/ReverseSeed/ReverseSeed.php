...
class ReverseSeed {
	 ...
	 * @param  int 	   $max
	 * @return bool
	 * @throws \Multi\Packages\ReverseSeed\TableNotFoundException
	 */
	...
	{
		return base_path(\Config::get('reverseSeed.path'));
	}
	...
	{
        $chunkSize = $chunkSize ?: \Config::get('reverseSeed.chunk_size');
    ...
    */
	...
	{
		$databaseSeederPath = base_path(\Config::get('reverseSeed.path') . '/DatabaseSeeder.php');
