...
class Authorize
{
     ...
     * @return bool
     */
    protected function hasRequiredAbility(/** @var \Hello\Users\User $user */$user, $ability = null, $model = null)
    {
        if (!$user) {
            return false;
        }
     ...
     */
    protected function handleUnauthorizedRequest(/** @var \Illuminate\Http\Request $request */$request, $ability = null, $model = null)
    {
        if ($request->ajax()) {
